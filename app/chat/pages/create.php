...
<meta name="description" content="Create an encrypted P2P chat room.">
...
<div class="join-hero">
  ...
  <div class="join-screen">
    <div class="join-card">
      ...
      <h2 class="join-title" data-i18n="create.title">Create Room</h2>
      <p class="join-sub" data-i18n="create.sub">Create a new room and invite someone to chat.</p>
      ...
      <button id="createBtn" class="join-btn"><i class="fa-solid fa-plus"></i> <span data-i18n="create.btn">Create Room</span></button>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - P2P Chat', 'hub.chat.title': 'P2P Chat', 'create.title': 'Create Room', 'create.sub': 'Create a new room and invite someone to chat.', 'create.name': 'Your Name', 'create.btn': 'Create Room' },
  ar: { 'page.title': 'سرداب - دردشة P2P', 'hub.chat.title': 'دردشة P2P', 'create.title': 'إنشاء غرفة', 'create.sub': 'أنشئ غرفة جديدة وادع شخصاً للدردشة.', 'create.name': 'اسمك', 'create.btn': 'إنشاء غرفة' }
});
</script>
<script>
...
<script src="<?=$basePath?>/app/chat/assets/js/create.js"></script>
</body>
</html>