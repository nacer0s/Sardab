...
<meta name="description" content="End-to-end encrypted P2P chat. Join or create a secure room.">
...
<body>
<div id="app">
<?php $navBack=$basePath.'/app/'; $navApp='hub.chat.title'; include __DIR__.'/../../../includes/nav.php'; ?>
<div class="hub-hero">
  <div class="hub-bg">
  ...
  <div class="hub-intro">
    <span class="hub-badge"><i class="fa-solid fa-comments"></i> <span data-i18n="hub.title">P2P Chat</span></span>
    <h1 data-i18n="hub.title">P2P Chat</h1>
    <p data-i18n="hub.sub">End-to-end encrypted messages. The server never sees your messages.</p>
  </div>
  <div class="hub-actions">
    <a href="<?=$basePath?>/app/chat/join/" class="hub-card">
      <div class="hub-card-icon"><i class="fa-solid fa-right-to-bracket"></i></div>
      <h2 data-i18n="hub.join">Join Room</h2>
      <p data-i18n="hub.join.desc">Enter a room code and start chatting instantly.</p>
    </a>
    <a href="<?=$basePath?>/app/chat/create/" class="hub-card">
      <div class="hub-card-icon"><i class="fa-solid fa-plus"></i></div>
      <h2 data-i18n="hub.create">Create Room</h2>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - P2P Chat', 'hub.chat.title': 'P2P Chat', 'hub.title': 'P2P Chat', 'hub.sub': 'End-to-end encrypted messages. The server never sees your messages.', 'hub.join': 'Join Room', 'hub.join.desc': 'Enter a room code and start chatting instantly.', 'hub.create': 'Create Room', 'hub.create.desc': 'Create a room and share the invite link.' },
  ar: { 'page.title': 'سرداب - دردشة P2P', 'hub.chat.title': 'دردشة P2P', 'hub.title': 'دردشة P2P', 'hub.sub': 'رسائل مشفرة من طرف لطرف. الخادم لا يرى رسائلك.', 'hub.join': 'انضمام لغرفة', 'hub.join.desc': 'أدخل رمز الغرفة وابدأ الدردشة فوراً.', 'hub.create': 'إنشاء غرفة', 'hub.create.desc': 'أنشئ غرفة وشارك رابط الدعوة.' }
});
</script>
<script>
