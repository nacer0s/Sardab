...
<meta name="description" content="Create an encrypted video call room.">
...
<div class="join-hero">
  ...
  <div class="join-screen">
    <div class="join-card">
      ...
      <h2 class="join-title" data-i18n="create.title">Start a Call</h2>
      <p class="join-sub" data-i18n="create.sub">Create a new room and video call someone.</p>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - Video Call', 'hub.video.title': 'Video Call', 'create.title': 'Start a Call', 'create.sub': 'Create a new room and video call someone.', 'create.name': 'Your Name', 'create.btn': 'Start Call' },
  ar: { 'page.title': 'سرداب - مكالمة فيديو', 'hub.video.title': 'مكالمة فيديو', 'create.title': 'بدء مكالمة', 'create.sub': 'أنشئ غرفة جديدة واتصل بشخص عبر الفيديو.', 'create.name': 'اسمك', 'create.btn': 'بدء مكالمة' }
});
</script>
<script>
...
<script src="<?=$basePath?>/app/video/assets/js/create.js"></script>
</body>
</html>
