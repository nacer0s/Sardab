...
<meta name="description" content="Join an encrypted video call room.">
...
<div class="join-hero">
  ...
  <div class="join-screen">
    <div class="join-card">
      ...
      <h2 class="join-title" data-i18n="join.title">Join Call</h2>
      <p class="join-sub" data-i18n="join.sub">Enter a room code to join a video call.</p>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - Video Call', 'hub.video.title': 'Video Call', 'join.title': 'Join Call', 'join.sub': 'Enter a room code to join a video call.', 'join.room': 'Room Code', 'join.name': 'Display Name', 'join.btn': 'Join' },
  ar: { 'page.title': 'سرداب - مكالمة فيديو', 'hub.video.title': 'مكالمة فيديو', 'join.title': 'انضمام', 'join.sub': 'أدخل رمز الغرفة للانضمام إلى مكالمة فيديو.', 'join.room': 'رمز الغرفة', 'join.name': 'اسم العرض', 'join.btn': 'دخول' }
});
</script>
<script>
...
<script src="<?=$basePath?>/app/video/assets/js/join.js"></script>
</body>
</html>
