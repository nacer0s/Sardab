...
<meta name="description" content="End-to-end encrypted video calls. Join or start a secure call.">
...
<body>
<div id="app">
<?php $navBack=$basePath.'/app/'; $navApp='hub.video.title'; include __DIR__.'/../../../includes/nav.php'; ?>
<div class="hub-hero">
  <div class="hub-bg">
  ...
  <div class="hub-intro">
    <span class="hub-badge"><i class="fa-solid fa-video"></i> <span data-i18n="hub.title">Video Call</span></span>
    <h1 data-i18n="hub.title">Video Call</h1>
    <p data-i18n="hub.sub">End-to-end encrypted video calls.</p>
  </div>
  <div class="hub-actions">
    <a href="<?=$basePath?>/app/video/join/" class="hub-card">
      <div class="hub-card-icon"><i class="fa-solid fa-right-to-bracket"></i></div>
      <h2 data-i18n="hub.join">Join Call</h2>
      <p data-i18n="hub.join.desc">Enter a room code and connect instantly.</p>
    </a>
    <a href="<?=$basePath?>/app/video/create/" class="hub-card">
      <div class="hub-card-icon"><i class="fa-solid fa-plus"></i></div>
      <h2 data-i18n="hub.create">Start a Call</h2>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - Video Call', 'hub.video.title': 'Video Call', 'hub.title': 'Video Call', 'hub.sub': 'End-to-end encrypted video calls.', 'hub.join': 'Join Call', 'hub.join.desc': 'Enter a room code and connect instantly.', 'hub.create': 'Start a Call', 'hub.create.desc': 'Create a room and share the invite link.' },
  ar: { 'page.title': 'سرداب - مكالمة فيديو', 'hub.video.title': 'مكالمة فيديو', 'hub.title': 'مكالمة فيديو', 'hub.sub': 'مكالمات فيديو مشفرة من طرف لطرف.', 'hub.join': 'انضمام', 'hub.join.desc': 'أدخل رمز الغرفة واتصل فوراً.', 'hub.create': 'بدء مكالمة', 'hub.create.desc': 'أنشئ غرفة وشارك رابط الدعوة.' }
});
</script>
<script>
