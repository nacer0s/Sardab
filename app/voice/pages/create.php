...
<meta name="description" content="Create an encrypted voice call room.">
...
<div class="join-hero">
  ...
  <div class="join-screen">
    <div class="join-card">
      ...
      <h2 class="join-title" data-i18n="create.title">Start Voice Call</h2>
      ...
      <button id="createBtn" class="join-btn"><i class="fa-solid fa-plus"></i> <span data-i18n="create.btn">Start Call</span></button>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - Voice Call', 'hub.voice.title': 'Voice Call', 'create.title': 'Start Voice Call', 'create.sub': 'Create a new room and invite participants.', 'create.name': 'Your Name', 'create.btn': 'Start Call' },
  ar: { 'page.title': 'سرداب - مكالمة صوتية', 'hub.voice.title': 'مكالمة صوتية', 'create.title': 'بدء مكالمة صوتية', 'create.sub': 'أنشئ غرفة جديدة وادع المشاركين.', 'create.name': 'اسمك', 'create.btn': 'بدء مكالمة' }
});
</script>
<script>
...
<script src="<?=$basePath?>/app/voice/assets/js/create.js"></script>
</body>
</html>