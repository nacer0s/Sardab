...
<meta name="description" content="End-to-end encrypted voice calls. Join or start a secure call.">
...
<body>
<div id="app">
<?php $navBack=$basePath.'/app/'; $navApp='hub.voice.title'; include __DIR__.'/../../../includes/nav.php'; ?>
<div class="hub-hero">
  <div class="hub-bg">
  ...
  <div class="hub-intro">
    <span class="hub-badge"><i class="fa-solid fa-phone"></i> <span data-i18n="hub.title">Voice Call</span></span>
    <h1 data-i18n="hub.title">Voice Call</h1>
    <p data-i18n="hub.sub">End-to-end encrypted voice calls with screen sharing.</p>
  </div>
  <div class="hub-actions">
    <a href="<?=$basePath?>/app/voice/join/" class="hub-card">
      <div class="hub-card-icon"><i class="fa-solid fa-right-to-bracket"></i></div>
      <h2 data-i18n="hub.join">Join Call</h2>
      <p data-i18n="hub.join.desc">Enter a room code and join the voice call.</p>
    </a>
    <a href="<?=$basePath?>/app/voice/create/" class="hub-card">
      <div class="hub-card-icon"><i class="fa-solid fa-plus"></i></div>
      <h2 data-i18n="hub.create">Start Call</h2>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - Voice Call', 'hub.voice.title': 'Voice Call', 'hub.title': 'Voice Call', 'hub.sub': 'End-to-end encrypted voice calls with screen sharing.', 'hub.join': 'Join Call', 'hub.join.desc': 'Enter a room code and join the voice call.', 'hub.create': 'Start Call', 'hub.create.desc': 'Create a room and share the invite link.' },
  ar: { 'page.title': 'سرداب - مكالمة صوتية', 'hub.voice.title': 'مكالمة صوتية', 'hub.title': 'مكالمة صوتية', 'hub.sub': 'مكالمات صوتية مشفرة من طرف لطرف مع مشاركة الشاشة.', 'hub.join': 'انضمام', 'hub.join.desc': 'أدخل رمز الغرفة وانضم للمكالمة الصوتية.', 'hub.create': 'بدء مكالمة', 'hub.create.desc': 'أنشئ غرفة وشارك رابط الدعوة.' }
});
</script>
<script>
