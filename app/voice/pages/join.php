...
<meta name="description" content="Join an encrypted voice call room.">
...
<div class="join-hero">
  ...
  <div class="join-screen">
    <div class="join-card">
      ...
      <p class="join-sub" data-i18n="join.sub">Enter a room code to join an existing call.</p>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - Voice Call', 'hub.voice.title': 'Voice Call', 'join.title': 'Join Voice Call', 'join.sub': 'Enter a room code to join an existing call.', 'join.room': 'Room Code', 'join.name': 'Display Name', 'join.btn': 'Join' },
  ar: { 'page.title': 'سرداب - مكالمة صوتية', 'hub.voice.title': 'مكالمة صوتية', 'join.title': 'انضمام للمكالمة', 'join.sub': 'أدخل رمز الغرفة للانضمام إلى مكالمة موجودة.', 'join.room': 'رمز الغرفة', 'join.name': 'اسم العرض', 'join.btn': 'دخول' }
});
</script>
<script>
...
<script src="<?=$basePath?>/app/voice/assets/js/join.js"></script>
</body>
</html>