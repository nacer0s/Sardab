...
<meta name="description" content="Waiting room for encrypted voice call.">
...
<body>
<div id="app">
<?php $navBack=$basePath.'/app/voice/'; $navApp='hub.voice.title'; include __DIR__.'/../../../includes/nav.php'; ?>
<div class="lobby-hero">
  ...
  <div class="lobby" id="lobby">
    <div class="lobby-card">
      ...
      <div class="lobby-qr"><img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=<?=urlencode((isset($_SERVER['HTTPS'])&&$_SERVER['HTTPS']==='on'?'https':'http').'://'.$_SERVER['HTTP_HOST'].'/app/voice/lobby/'.urlencode($room))?>" alt="QR" onerror="this.parentElement.style.display='none'"></div>
      <div class="lobby-link" id="inviteLinkRow">
        <span id="inviteLinkText" style="word-break:break-all;font-family:var(--mono);font-size:11px"><?=htmlspecialchars((isset($_SERVER['HTTPS'])&&$_SERVER['HTTPS']==='on'?'https':'http').'://'.$_SERVER['HTTP_HOST'].'/app/voice/lobby/'.urlencode($room))?></span>
      </div>
...
<div class="lobby-overlay" id="joinOverlay">
  <div class="lobby-card" style="max-width:360px">
    <div class="lobby-icon"><i class="fa-solid fa-phone"></i></div>
    <div class="lobby-title" data-i18n="lobby.join_title">Join Voice Call</div>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - Voice Call', 'hub.voice.title': 'Voice Call', 'lobby.room': 'Room Code', 'lobby.waiting': 'Waiting for participants...', 'lobby.redirecting': 'Connected! Entering call...', 'lobby.copy': 'Copy Link', 'lobby.join_title': 'Join Voice Call', 'lobby.join_sub': 'Enter your name to join this call.', 'lobby.join_btn': 'Join', 'copy': 'Copy', 'copied': 'Copied!' },
  ar: { 'page.title': 'سرداب - مكالمة صوتية', 'hub.voice.title': 'مكالمة صوتية', 'lobby.room': 'رمز الغرفة', 'lobby.waiting': 'في انتظار المشاركين...', 'lobby.redirecting': 'تم الاتصال! جارٍ دخول المكالمة...', 'lobby.copy': 'نسخ الرابط', 'lobby.join_title': 'انضمام للمكالمة', 'lobby.join_sub': 'أدخل اسمك للانضمام إلى هذه المكالمة.', 'lobby.join_btn': 'دخول', 'copy': 'نسخ', 'copied': 'تم النسخ!' }
});
</script>
<script>
...
<script src="<?=$basePath?>/app/voice/assets/js/lobby.js"></script>
</body>
</html>