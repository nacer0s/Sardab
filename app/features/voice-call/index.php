...
<body<?php if ($presetRoom): ?> data-room-id="<?= $presetRoom ?>"<?php endif; ?>>
  ...
  <main class="page">
    ...
    <div class="page-header">
      <h1>P2P <span class="text-gradient">Voice Call</span></h1>
      <p>Encrypted audio calls. Your voice never passes through any server. <span class="badge badge-amber">Beta</span></p>
    </div>
    ...
    <div class="card card-premium">
      ...
      <div class="p2p-mode-selector">
        <button class="p2p-mode-btn active" data-p2p-mode="send"><i class="fa-solid fa-phone"></i> Call</button>
        <button class="p2p-mode-btn" data-p2p-mode="recv"><i class="fa-solid fa-phone-slash"></i> Receive</button>
      </div>
      ...
      <div class="call-screen" id="call-screen">
        ...
        <div class="call-waves" id="call-waves">
        ...
        <div class="call-info">
          <span class="call-status-text" id="call-status">Call Active</span>
          <span class="call-ended-text" id="call-ended-text">Call Ended</span>
        </div>
      ...
      <div class="card-footer">
        <p>Audio is encrypted end-to-end. No server can listen.</p>
      </div>
  ...
  <script src="/app/features/voice-call/voice-call.js"></script>
</body>
</html>