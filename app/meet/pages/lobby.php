...
<meta name="description" content="Waiting room for encrypted meeting.">
...
<div class="lobby-hero">
  ...
  <div class="lobby" id="lobby">
    <div class="lobby-card">
      ...
      <div class="lobby-qr"><img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=<?=urlencode((isset($_SERVER['HTTPS'])&&$_SERVER['HTTPS']==='on'?'https':'http').'://'.$_SERVER['HTTP_HOST'].'/app/meet/lobby/'.urlencode($room))?>" alt="QR" onerror="this.parentElement.style.display='none'"></div>
      <div class="lobby-link" id="inviteLinkRow">
        <span id="inviteLinkText" style="word-break:break-all;font-family:var(--mono);font-size:11px"><?=htmlspecialchars((isset($_SERVER['HTTPS'])&&$_SERVER['HTTPS']==='on'?'https':'http').'://'.$_SERVER['HTTP_HOST'].'/app/meet/lobby/'.urlencode($room))?></span>
      </div>
...
<div class="lobby-overlay" id="joinOverlay">
  <div class="lobby-card" style="max-width:360px">
    <div class="lobby-icon"><i class="fa-solid fa-people-group"></i></div>
    <div class="lobby-title" data-i18n="lobby.join_title">Join Meeting</div>
    <div class="lobby-sub" data-i18n="lobby.join_sub">Enter your name to join this meeting.</div>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - Meet', 'hub.meet.title': 'Meet', 'lobby.room': 'Room Code', 'lobby.waiting': 'Waiting for participants...', 'lobby.redirecting': 'Connected! Entering room...', 'lobby.copy': 'Copy Link', 'lobby.join_title': 'Join Meeting', 'lobby.join_sub': 'Enter your name to join this meeting.', 'lobby.join_btn': 'Join', 'copy': 'Copy', 'copied': 'Copied!' },
  ar: { 'page.title': 'سرداب - اجتماع', 'hub.meet.title': 'اجتماع', 'lobby.room': 'رمز الغرفة', 'lobby.waiting': 'في انتظار المشاركين...', 'lobby.redirecting': 'تم الاتصال! جارٍ دخول الغرفة...', 'lobby.copy': 'نسخ الرابط', 'lobby.join_title': 'انضمام للاجتماع', 'lobby.join_sub': 'أدخل اسمك للانضمام إلى هذا الاجتماع.', 'lobby.join_btn': 'دخول', 'copy': 'نسخ', 'copied': 'تم النسخ!' }
});
</script>
<script>
...
<script src="<?=$basePath?>/app/meet/assets/js/lobby.js"></script>
</body>
</html>