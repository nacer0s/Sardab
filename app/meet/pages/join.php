...
<meta name="description" content="Join an encrypted group meeting room.">
...
<div class="join-hero">
  ...
  <div class="join-screen">
    <div class="join-card">
      ...
      <p class="join-sub" data-i18n="join.sub">Enter a room code to join a meeting.</p>
...
i18n.setTranslations({
  en: { 'page.title': 'Sardab - Meet', 'hub.meet.title': 'Meet', 'join.title': 'Join Meeting', 'join.sub': 'Enter a room code to join a meeting.', 'join.room': 'Room Code', 'join.name': 'Display Name', 'join.btn': 'Join' },
  ar: { 'page.title': 'سرداب - اجتماع', 'hub.meet.title': 'اجتماع', 'join.title': 'انضمام', 'join.sub': 'أدخل رمز الغرفة للانضمام إلى اجتماع.', 'join.room': 'رمز الغرفة', 'join.name': 'اسم العرض', 'join.btn': 'دخول' }
});
</script>
<script>
...
<script src="<?=$basePath?>/app/meet/assets/js/join.js"></script>
</body>
</html>